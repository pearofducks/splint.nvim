describe('from_errorformat', function()
  it('Parses single-line errorformat', function()
    ...
    local parser = require('splint.parser').from_errorformat(efm, skeleton)
    local output = [[
...
dir2/file2.txt:20:25:W:300:Bigger mistake
  ...
  it('Strips newlines and whitespace from error message', function()
    ...
    -- newline character
    local parser = require('splint.parser').from_errorformat('%W%l,%Z%m')
...
describe('from_pattern', function()
  it('Uses source from defaults', function()
    ...
    local parser = require('splint.parser').from_pattern(pattern, groups, severity_map, defaults)
    local output = [[
...
bar:209:14 Bigger mistake
  ...
  it("supports lpeg pattern", function()
    ...
    local parser = require('splint.parser').from_pattern(pattern, groups)
    local output = [[
10:Big mistake
14:Bigger mistake
]]
