local gitlint_numbered_parser = require("splint.parser").from_pattern("^(%d+): (%w+) (.*)$", { "lnum", "code", "message" })
local gitlint_generic_parser = require("splint.parser").from_pattern("^-: (%w+) (.*)$", { "code", "message" })
